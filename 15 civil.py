...
for num in range(0,63500,50):
    if num is 0:
        name = "http://kenyalaw.org/caselaw/cases/classes/1/"
    else:
        name = "http://kenyalaw.org/caselaw/cases/classes/1/" + str(num) + "/"
    ...
    for tag in tags:
        ...
        result = database.civil.insert_one(
            {
                "header" : header,

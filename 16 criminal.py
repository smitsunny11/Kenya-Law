...
for num in range(0,22000,50):
    if num is 0:
        name = "http://kenyalaw.org/caselaw/cases/classes/2/"
    else:
        name = "http://kenyalaw.org/caselaw/cases/classes/2/" + str(num) + "/"
    ...
    for tag in tags:
        ...
        result = database.criminal.insert_one(
            {
                "header" : header,
